...
# Home
if selected == "Home":
    st.image("https://asset.kompas.com/crops/Jzw0gMc6Ue5guxzXg2mLTmocaHQ=/0x95:864x671/750x500/data/photo/2021/01/29/6013c725bad86.jpeg", caption="Destinasi Pariwisata Jombang")
...
# Dataset
    ...
    st.write("""
        <div style="text-align:justify;">
        Dataset yang digunakan merupakan data ulasan dari 15 tempat pariwisata di Kabupaten Jombang yang ada pada google maps dengan menggunakan teknik scraping. Setelah pengumpulan data, langkah selanjutnya adalah melakukan penyaringan data. Selanjutnya tahap pelabelan dilakukan secara manual dengan berdasarkan sentimen yang terkandung dalam ulasan yaitu positif dan negatif.
